<html>
    <head>
        ...
        <p><marquee>View Student Information</marquee></p>
<br />
...
?>
          <form name  ="myform" action="Administrator.php" method="get">
              <table align="center">
                  <tr>
                      <td align="center">
                     <input type="submit" value="Back"style="width:150px;height:35px;background-color:yellow" /> 
                      </td>
                  </tr>
                  <table>
              </form>
        ...
        <form name  ="myform" action="enterstudentusn.php" method="get">
            <table align="center">
                <tr>
                    <td align="center">
                     <input type="submit" value="View" style="width:150px;height:35px;background-color:yellow"/> 
                    </td>
                </tr>
            </table>
              </form>
